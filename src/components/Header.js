          ...
          <div className="row">
            <div className="col-6">
              <p className='text-white mb-0'>
                Giao hàng miễn phí khi mua sắm trên 2 triệu
              </p>
            </div>
            <div className="col-6">
              <p className='text-end text-white mb-0'>
                Hotline: 
                <a className='text-white' href='tel: +91 888888'>
                  +91 888888
                </a>
              </p>
            </div>
          ...
          <div className='row align-items-center'>
            ...
            <div className='col-5'>
              <div className="input-group">
                <input type="text" className="form-control py-2" placeholder="Nhập tên sản phẩm..." aria-label="Nhập tên sản phẩm..." aria-describedby="basic-addon2" />
